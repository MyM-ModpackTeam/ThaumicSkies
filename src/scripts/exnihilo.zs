...
mods.exnihilo.Sieve.addRecipe(<exnihilo:dust>,[<minecraft:dye:15>, <minecraft:redstone>, <minecraft:gunpowder>, <minecraft:glowstone_dust>, <minecraft:blaze_powder>, <ThermalFoundation:material:16>, <appliedenergistics2:item.ItemMultiMaterial:2>, <appliedenergistics2:item.ItemMultiMaterial:2>, <appliedenergistics2:item.ItemMultiMaterial:45>],[5, 8, 14, 17, 20, 33, 6, 8, 8]);
